...
func (m *fakeManager) GetAllocatedResources(pod *v1.Pod, container *v1.Container) string {
	klog.Infof("[fake memorymanager] GetAllocatedResources (pod: %s, container: %s)", pod.Name, container.Name)
	return ""
}
